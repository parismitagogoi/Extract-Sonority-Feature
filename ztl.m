function [hngd,f,dngd,ngd,mag,hgd,dgd,gd,w,w2] = ztl(x,fs,nfft,nwin,PLOTFLAG)
...
[gd,f,ngd,mgd,mag]=gdelay1d(xw,nfft,fs);
...
% hngd=abs(hilbert(dngd));  
% hgd=abs(hilbert(dgd));
% 
% 
% hngd=abs(hilbert(diff(dngd)));  %%%%%%%%%%%%%%original
